  ...
  return (
    <div className="min-h-screen  py-8 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200">
          <div className="p-6">
        ...
        {departmentNames
          ...
          .map(deptName => (
          <div key={deptName} className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 bg-gradient-to-r from-blue-50 to-green-50">
