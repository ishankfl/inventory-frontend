            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            <h1 className="text-3xl font-bold text-text mb-2">Receipts Management</h1>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-text">Rs. {totalAmount.toLocaleString()}</p>
                                </div>
                    ...
                    <div className="view-container overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Bill No</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Date</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Vendor</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Items</th>
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-white uppercase tracking-wider">Total Amount</th>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex space-x-2">
                                                    <button 
                                                        ...
                                                        className="p-2 text-primary hover:bg-card1color rounded-lg transition-colors duration-200"
                                                        title="View Receipt"
                                                    >
                                                    ...
                                                    <button 
                                                        ...
                                                        className="p-2 text-accent hover:bg-card3color rounded-lg transition-colors duration-200"
                                                        title="Edit Receipt"
                                                    >
